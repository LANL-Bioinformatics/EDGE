...
sub parse_lineage{
	...
	while(<$fh>){
		...
		if ($lineage_assign eq 'B.1.1.7' or $lineage_assign eq 'P.1' or $lineage_assign eq 'P.1.1' or $lineage_assign =~ /B.1.351/ or $lineage_assign =~ /B.1.427/ or $lineage_assign =~ /B.1.429/ ){
			$note .= "; VOC"; 
