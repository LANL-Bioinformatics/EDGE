...
def setup_argparse():
    ...
    parser.add_argument(
        '--lineageMutation', metavar='[FILE]', required=False, type=str, help=f"lineage mutation json file [default: {bin_dir}/variant_mutation.json]")
    parser.add_argument(
    ...
    parser.add_argument('-eo', '--ec19_projdir',
