...
if ($file_long and $paired_files and $singleton){
  &executeCommand("samtools merge -@ $samtools_threads -h $outDir/paired$$.bam $bam_output $outDir/paired$$.bam $outDir/singleton$$.bam $outDir/LongReads$$.bam");
}
elsif($file_long and $paired_files)
{
  &executeCommand("samtools merge -@ $samtools_threads -h $outDir/paired$$.bam $bam_output $outDir/paired$$.bam $outDir/LongReads$$.bam");
}
elsif($paired_files and $singleton)
{
  &executeCommand("samtools merge -@ $samtools_threads -h $outDir/paired$$.bam $bam_output $outDir/paired$$.bam $outDir/singleton$$.bam");
}
elsif($singleton and $file_long)
{
  &executeCommand("samtools merge -@ $samtools_threads -h $outDir/singleton$$.bam $bam_output $outDir/singleton$$.bam $outDir/LongReads$$.bam");
}
elsif($paired_files)
{
