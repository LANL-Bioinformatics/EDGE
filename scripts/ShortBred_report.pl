...
my $ARDB_tab_PATH="$RealBin/../database/ARDB";
...
my $text_output = "$out_dir/${category}_genes_ShortBRED_table.txt";
my $html_output = "$out_dir/${category}_genes_ShortBRED_table.html";
my $json_output = "$out_dir/${category}_genes_ShortBRED_table.json";
