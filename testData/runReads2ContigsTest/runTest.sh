...
test_result(){
	...
	TestLog=$rootdir/TestOutput/AssemblyBasedAnalysis/readsMappingToContig/mapping.log
	Test=$rootdir/TestOutput/AssemblyBasedAnalysis/readsMappingToContig/readsToContigs.alnstats.txt
	Expect=$rootdir/readsToContigs.alnstats.txt
