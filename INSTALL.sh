...
export PATH=$rootdir/bin/:$rootdir/thirdParty/Anaconda3/bin:$PATH
...
$anaconda3bin/conda update -n base -y --all
$anaconda3bin/conda install -n base -y conda-libmamba-solver
...
------------------------------------------------------------------------------
"
$anaconda3bin/conda install -y -c bioconda vcftools
...
$anaconda3bin/conda create -y -n antismash antismash=6.1.1
echo "
------------------------------------------------------------------------------
